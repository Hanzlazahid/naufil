...
export default function Portfolio({ searchParams }) {
        ...
        switch (searchParams.name) {
            case 'hot_pro_2':
                setContent({
                    ...
                    src2: "https://player.vimeo.com/video/957246770?h=37cc34fa4a",
                });
                break;
            case 'rocket_pro':
                setContent({
                    ...
                    shortsrc1: "https://player.vimeo.com/video/957246658?h=d8af4cacb0",
                    shortsrc2: "https://player.vimeo.com/video/957246592?h=b22002fbf8",
                    shortsrc3: "https://player.vimeo.com/video/957246559?h=3580562e12",
            ...
            case 'anti_bacterial_shoe':
                setContent({
                    ...
                    shortFormHeading: "Short Ad:",
                    shortsrc1: src = "https://player.vimeo.com/video/957246190?h=01c35334ab",
                });
                break;
            case 'toofani_mirch':
                setContent({
                    ...
                    shortFormHeading: "Short Ad:",
                    shortsrc1: "https://player.vimeo.com/video/957246063?h=ce7cc713f8",
                    shortsrc2: "https://player.vimeo.com/video/957245929?h=de265e218b",
                    shortsrc3: "https://player.vimeo.com/video/957245792?h=bd86b65dc5",
                });
                break;
            case 'packages_mall':
                setContent({
    ...
    const cardData = [
        { src: images.packagesMall, text: "Packages Mall", name: 'packages_mall' },
        { src: images.kurkure, text: "Kurkure: Toofani Mirch", name: 'kurkure' },
        { src: images.bFirst1, text: "Bata BFirst", name: 'b_first' },
        { src: images.bFirst2, text: "Bata BFirst", name: 'b_first' },
        { src: images.qsmart, text: "Q-Mobile QSmart", name: 'q_smart' },
        { src: images.hotPro2, text: "Hot Pro 2", name: 'hot_pro_2' },
    ];
