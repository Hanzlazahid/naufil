...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div className={`fixed top-[110px] left-1/2 transform -translate-x-1/2 w-4/5 py-3 border border-nav bg-white z-10 rounded-lg shadow-lg transition-all duration-300 ${isMobileNavOpen ? 'opacity-100 scale-100' : 'opacity-0 scale-90 pointer-events-none'}`}>
